...
create table public.internships (
  ...
  company_id uuid references public.profiles_names(id) on delete cascade not null,
  title text not null,
...
create table public.applications (
  ...
  student_id uuid references public.profiles_names(id) on delete cascade not null,
  cover_letter text,
  resume_link text,
...
create table public.messages (
  id uuid default uuid_generate_v4() primary key,
  sender_id uuid references public.profiles_names(id) on delete cascade not null,
  receiver_id uuid references public.profiles_names(id) on delete cascade not null,
